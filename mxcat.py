...
parser.add_argument('--output', metavar='output', type=str, nargs=1, help="File to write to. Exists for cross-compatability and multiple output. You can also use the UNIX feed operator > output.mscx, instead of this argument.", default=[0])
